...
public class MiramarLootFragment extends Fragment {
    DBHelper databaseHelper;
    RecyclerView miramarLootsRecycler;
    ArrayList<GeneralDataModel> miramarLootList;
